...
class BetExecutionTypeStrategy : ParsingStrategy {
    override fun buildPredicate(
        ...
        return when (condition) {
            Condition.EQUALS -> return builder.equal(
                GenericSpecification.extractPath<BetExecutionType>(path, fieldName),
                value
            )
    ...
    override fun parse(value: String?, fieldClass: KClass<out Any>): Any? {
        return java.lang.Enum.valueOf(BetExecutionType::class.java, value)
    }
}